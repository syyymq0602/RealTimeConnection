...
namespace GrpcGreeterClient {
    ...
    static GreetReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Cg5FeGFtcGxlUmVxdWVzdBIRCglwYWdlSW5kZXgYASABKAUSEAoIcGFnZVNp",
            "emUYAiABKAUSFAoMaXNEZXNjZW5kaW5nGAMgASgIIiUKD0V4YW1wbGVSZXNw",
            "b25zZRISCgpoYXNSZWNlaXZlGAEgASgJMtECCgdHcmVldGVyEjIKCFNheUhl",
            "bGxvEhMuZ3JlZXQuSGVsbG9SZXF1ZXN0GhEuZ3JlZXQuSGVsbG9SZXBseRI6",
            ...
            "KAEwAUIUqgIRR3JwY0dyZWV0ZXJDbGllbnRiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::GrpcGreeterClient.ExampleRequest), global::GrpcGreeterClient.ExampleRequest.Parser, new[]{ "PageIndex", "PageSize", "IsDescending" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::GrpcGreeterClient.ExampleResponse), global::GrpcGreeterClient.ExampleResponse.Parser, new[]{ "HasReceive" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "hasReceive" field.</summary>
    public const int HasReceiveFieldNumber = 1;
    private string hasReceive_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string HasReceive {
      get { return hasReceive_; }
      set {
        hasReceive_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (HasReceive.Length != 0) hash ^= HasReceive.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      output.WriteRawMessage(this);
    #else
      if (HasReceive.Length != 0) {
        output.WriteRawTag(10);
        output.WriteString(HasReceive);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (HasReceive.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(HasReceive);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(ExampleResponse other) {
      ...
      if (other.HasReceive.Length != 0) {
        HasReceive = other.HasReceive;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
